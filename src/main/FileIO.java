...
public class FileIO {
	private static final String FILE_DIRECTORY = "recipe_files/"; // Constant for directory where recipe files stored
	private static GUI gui; // Reference to the GUI for displaying messages
